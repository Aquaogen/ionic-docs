    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const promises = Object.keys(compilerCtx.moduleFiles)
            ...
            return {
                ...
                readme: yield getUserReadmeContent(compilerCtx, readmePath),
                usage: yield generateJsDocsUsages(config, compilerCtx, usagesDir),
...
function generateJsDocsUsages(config, compilerCtx, usagesDir) {
    return __awaiter(this, void 0, void 0, function* () {
        const rtn = {};
        try {
...
function docs(config, compilerCtx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield generateDocs(config, compilerCtx, buildCtx);
        }
        catch (e) {
            // catch all phase
            catchError(buildCtx.diagnostics, e);
...
function generateDocs(config, compilerCtx, buildCtx) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!config.buildDocs) {
            return;
        }
...
function minifyJs(config, compilerCtx, diagnostics, jsText, sourceTarget, preamble, buildTimestamp) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyJs', 'terser3.10.111', opts, jsText);
...
function transpileToEs5Main(config, compilerCtx, input, inlineHelpers = true) {
    return __awaiter(this, void 0, void 0, function* () {
        const cacheKey = compilerCtx.cache.createKey('transpileToEs5', 'typescript3.1.61', input);
        const cachedContent = yield compilerCtx.cache.get(cacheKey);
        if (cachedContent != null) {
            const results = {
                code: cachedContent,
...
function transpileCoreBuild(config, compilerCtx, coreBuild, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('transpileCoreBuild', 'typescript3.1.61', coreBuild, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
...
function minifyCore(config, compilerCtx, sourceTarget, input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let cacheKey;
        if (compilerCtx) {
            cacheKey = compilerCtx.cache.createKey('minifyCore', '181029170036', opts, input);
            const cachedContent = yield compilerCtx.cache.get(cacheKey);
            if (cachedContent != null) {
                return {
...
class Compiler {
    constructor(rawConfig) {
        ...
        if (this.isValid) {
            ...
            config.logger.debug(`compiler build: 181029170036`);
